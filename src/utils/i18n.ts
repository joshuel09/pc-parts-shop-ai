...
export const translations = {
  en: {
    ...
    'common.currency.jpy': '¥',
    'common.currency.position': 'before',
  ...
  jp: {
    ...
    'common.shipping': '送料',
    'common.discount': '割引',
    'common.currency.jpy': '円',
    'common.currency.position': 'after',
    ...
    'admin.topProducts': 'トップセラー商品（過去30日）',
